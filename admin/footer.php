...
<nav class="p-3 bg-white border mt-5">
  <center>
    <small><?php echo date('Y') ?> - Sistem Informasi Kuesioner Mahasiswa Berbasis Online.</small>
  </center>
</nav>
...
<script type="text/javascript">
 ...
 var barChartData = {
  ...
  datasets : [
  {
    ...
    while($p = mysqli_fetch_array($prodi)){
      $id_prodi = $p['prodi_id'];
      $jumlah = mysqli_query($koneksi,"SELECT * FROM mahasiswa WHERE mahasiswa_prodi='$id_prodi'");
