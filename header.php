...
<head>
  ...
  <title>SISTEM INFORMASI KUESIONER MAHASISWA ONLINE</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary border-bottom">
    <div class="container">
      <a class="navbar-brand" href="index.php"><b>KUESIONER MAHASISWA</b></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active mr-3">
            <a class="nav-link" href="survey.php"><i class="fa fa-pencil"></i> SURVEY</a>
          </li>
